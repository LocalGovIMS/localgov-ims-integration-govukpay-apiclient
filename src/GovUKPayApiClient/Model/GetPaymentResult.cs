...
namespace GovUKPayApiClient.Model
{
    ...
    /// GetPaymentResult
    /// </summary>
    [DataContract(Name = "GetPaymentResult")]
    public partial class GetPaymentResult : IEquatable<GetPaymentResult>, IValidatableObject
    {
        /// <summary>
        /// Defines Language
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPaymentResult" /> class.
        /// </summary>
        ...
        public GetPaymentResult(PaymentLinks links = default(PaymentLinks), long amount = default(long), AuthorisationSummary authorisationSummary = default(AuthorisationSummary), CardDetails cardDetails = default(CardDetails), string description = default(string), string email = default(string), LanguageEnum? language = default(LanguageEnum?), ExternalMetadata metadata = default(ExternalMetadata), bool moto = default(bool), string reference = default(string), RefundSummary refundSummary = default(RefundSummary), PaymentSettlementSummary settlementSummary = default(PaymentSettlementSummary), PaymentState state = default(PaymentState))
        {
            this.Links = links;
            this.Amount = amount;
        ...
        {
            return this.Equals(input as GetPaymentResult);
        }

        /// <summary>
        /// Returns true if GetPaymentResult instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPaymentResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPaymentResult input)
        {
            if (input == null)
            {
                return false;
